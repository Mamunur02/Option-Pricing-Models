...
# Class for calculating European options with the Black-Scholes formula
class BlackScholesModel(OptionPricingModel):
    ...
    # Formula is: S*N(d1) - K*N(d2) where N is the CDF of the standard normal distribution
